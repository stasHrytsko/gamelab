...
export const GLYPH: Readonly<Record<TaxiColor, string>> = {
...
export const glyph = (color: TaxiColor, cls = 'glyph'): string => svg(GLYPH[color], cls);
...
export const icon = {
  ...
  person: svg('<circle cx="12" cy="7.5" r="4" fill="currentColor"/><path d="M4 20.5c0-4.4 3.6-7 8-7s8 2.6 8 7z" fill="currentColor"/>'),
