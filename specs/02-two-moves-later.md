...
| 2 | 21 такси, 4 пустоты | 4; запас +4 | 1 → 1 → 1 → 1 | 1 | 6–8 | подвинуть чужое такси ради пустоты | теснота | 11 / 5 | 55% |
| 3 | 20 такси, 5 пустот | 5; запас +3 | 1 → 1 → 2 → 1 | 2 | 5–9 | двое ждут одновременно | общий расход ходов | 13 / 6 | 33% |
| 4 | 21 такси, 4 пустоты | 7; запас +3 | 1 → 2 → 2 → 2 | 2 | 5–10 | планировать пустоту на два заказа вперёд | теснота и пары | 19 / 8 | 13% |
| 5 | 21 такси, 4 пустоты | 8; запас +2 | 3 → 3 → 2 | 3 | по генератору | держать в голове три заказа сразу | три дедлайна на одно поле | после сборки | 5–8% |

`unlockAfterServed` по уровням: 1 — `0, 1, 2`; 2 — `0, 1, 2, 3`; 3 — `0, 1,
2, 2, 4`; 4 — `0, 1, 1, 3, 3, 5, 5`; 5 — `0, 0, 0, 3, 3, 3, 6, 6`.
